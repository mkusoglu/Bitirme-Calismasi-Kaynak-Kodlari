...
num_epoch=1000
model=build_model()
csv_logger =  CSVLogger("8x8_1000e_opt=rmsprop_loss=mse_split=2_random.csv", append=True)
model.fit(x_train,y_train,
              epochs=num_epoch,batch_size=1,verbose=1,callbacks=[csv_logger])

his=pd.read_csv('8x8_1000e_opt=rmsprop_loss=mse_split=2_random.csv')
...
num_epoch=1000
model1=build_model1()
csv_logger1 =  CSVLogger("8x8_1000e_opt=rmsprop_loss=mae_split=2_random.csv", append=True)
model1.fit(x_train,y_train,
              epochs=num_epoch,batch_size=1,verbose=1,callbacks=[csv_logger1])

his1=pd.read_csv('8x8_1000e_opt=rmsprop_loss=mae_split=2_random.csv')
...
num_epoch=1000
model2=build_model2()
csv_logger2 =  CSVLogger("8x8_1000e_opt=rmsprop_loss=huber_split=2_random.csv", append=True)
model1.fit(x_train,y_train,
              epochs=num_epoch,batch_size=1,verbose=1,callbacks=[csv_logger2])

his2=pd.read_csv('8x8_1000e_opt=rmsprop_loss=huber_split=2_random.csv')
...
num_epoch3=5000
model3=build_model3()
csv_logger3 =  CSVLogger("8x8_5000e_opt=rmsprop_loss=mse_split=2_random.csv", append=True)
model3.fit(x_train,y_train,
              epochs=num_epoch3,batch_size=1,verbose=1,callbacks=[csv_logger3])

his3=pd.read_csv('8x8_5000e_opt=rmsprop_loss=mse_split=2_random.csv')
...
num_epoch4=5000
model4=build_model4()
csv_logger4 =  CSVLogger("8x8_5000e_opt=rmsprop_loss=mae_split=2_random.csv", append=True)
model4.fit(x_train,y_train,
              epochs=num_epoch4,batch_size=1,verbose=1,callbacks=[csv_logger4])

his4=pd.read_csv('8x8_5000e_opt=rmsprop_loss=mae_split=2_random.csv')
...
num_epoch5=5000
model5=build_model5()
csv_logger5 =  CSVLogger("8x8_5000e_opt=rmsprop_loss=huber_loss_split=2_random.csv", append=True)
model5.fit(x_train,y_train,
              epochs=num_epoch5,batch_size=1,verbose=1,callbacks=[csv_logger5])

his5=pd.read_csv('8x8_5000e_opt=rmsprop_loss=huber_loss_split=2_random.csv')
...
num_epoch6=1000
model6=build_model6()
csv_logger6 =  CSVLogger("8x8_1000e_opt=rmsprop_loss=mse_split=2_bk.csv", append=True)
model6.fit(x_train2,y_train2,
              epochs=num_epoch6,batch_size=1,verbose=1,callbacks=[csv_logger6])

his6=pd.read_csv('8x8_1000e_opt=rmsprop_loss=mse_split=2_bk.csv')
...
num_epoch7=1000
model7=build_model7()
csv_logger7 =  CSVLogger("8x8_1000e_opt=rmsprop_loss=mae_split=2_bk.csv", append=True)
model7.fit(x_train2,y_train2,
              epochs=num_epoch7,batch_size=1,verbose=1,callbacks=[csv_logger7])

his7=pd.read_csv('8x8_1000e_opt=rmsprop_loss=mae_split=2_bk.csv')
...
num_epoch7=1000
model7=build_model7()
csv_logger7 =  CSVLogger("8x8_1000e_opt=rmsprop_loss=huber_split=2_bk.csv", append=True)
model7.fit(x_train2,y_train2,
              epochs=num_epoch7,batch_size=1,verbose=1,callbacks=[csv_logger7])

his7=pd.read_csv('8x8_1000e_opt=rmsprop_loss=huber_split=2_bk.csv')
...
num_epoch8=5000
model8=build_model8()
csv_logger8 =  CSVLogger("8x8_5000e_opt=rmsprop_loss=mse_split=2_bk.csv", append=True)
model8.fit(x_train2,y_train2,
              epochs=num_epoch8,batch_size=1,verbose=1,callbacks=[csv_logger8])

his8=pd.read_csv('8x8_5000e_opt=rmsprop_loss=mse_split=2_bk.csv')
...
num_epoch9=5000
model9=build_model9()
csv_logger9 =  CSVLogger("8x8_5000e_opt=rmsprop_loss=mae_split=2_bk.csv", append=True)
model9.fit(x_train2,y_train2,
              epochs=num_epoch9,batch_size=1,verbose=1,callbacks=[csv_logger9])

his9=pd.read_csv('8x8_5000e_opt=rmsprop_loss=mae_split=2_bk.csv')
...
csv_logger10 =  CSVLogger("8x8_5000e_opt=rmsprop_loss=huber_loss_split=2_bk.csv", append=True)
model10.fit(x_train2,y_train2,
              epochs=num_epoch10,batch_size=1,verbose=1,callbacks=[csv_logger10])

his10=pd.read_csv('8x8_5000e_opt=rmsprop_loss=huber_loss_split=2_bk.csv')
...
csv_logger11 =  CSVLogger("8x8_1000e_opt=rmsprop_loss=mse_split=2_kb.csv", append=True)
model11.fit(x_train3,y_train3,
              epochs=num_epoch11,batch_size=1,verbose=1,callbacks=[csv_logger11])

his11=pd.read_csv('8x8_1000e_opt=rmsprop_loss=mse_split=2_kb.csv')
...
csv_logger12 =  CSVLogger("8x8_1000e_opt=rmsprop_loss=mae_split=2_kb.csv", append=True)
model12.fit(x_train3,y_train3,
              epochs=num_epoch12,batch_size=1,verbose=1,callbacks=[csv_logger12])

his12=pd.read_csv('8x8_1000e_opt=rmsprop_loss=mae_split=2_kb.csv')
...
csv_logger13 =  CSVLogger("8x8_1000e_opt=rmsprop_loss=huber_split=2_kb.csv", append=True)
model7.fit(x_train3,y_train3,
              epochs=num_epoch13,batch_size=1,verbose=1,callbacks=[csv_logger13])

his13=pd.read_csv('8x8_1000e_opt=rmsprop_loss=huber_split=2_bk.csv')
...
csv_logger14 =  CSVLogger("8x8_5000e_opt=rmsprop_loss=mse_split=2_kb.csv", append=True)
model14.fit(x_train3,y_train3,
              epochs=num_epoch14,batch_size=1,verbose=1,callbacks=[csv_logger14])

his14=pd.read_csv('8x8_5000e_opt=rmsprop_loss=mse_split=2_kb.csv')
...
csv_logger15 =  CSVLogger("8x8_5000e_opt=rmsprop_loss=mae_split=2_kb.csv", append=True)
model15.fit(x_train3,y_train3,
              epochs=num_epoch15,batch_size=1,verbose=1,callbacks=[csv_logger15])

his15=pd.read_csv('8x8_5000e_opt=rmsprop_loss=mae_split=2_kb.csv')
...
num_epoch8=5000
model8=build_model8()
csv_logger8 =  CSVLogger("8x8_5000e_opt=rmsprop_loss=huber_loss_split=2_kb.csv", append=True)
model8.fit(x_train3,y_train3,
              epochs=num_epoch8,batch_size=1,verbose=1,callbacks=[csv_logger8])

his8=pd.read_csv('8x8_5000e_opt=rmsprop_loss=huber_loss_split=2_kb.csv')
tahm8=model8.predict(x_test3)
tah8=pd.DataFrame(tahm8)