...
model7=build_model7()
csv_logger7 =  CSVLogger("4_5000e_opt=rms_loss=mae_split=2_bk.csv", append=True)
model7.fit(x_train,y_train,
              epochs=5000,batch_size=1,verbose=1,callbacks=[csv_logger7])

his7=pd.read_csv('4_5000e_opt=rms_loss=mae_split=2_bk.csv')
...
model=build_model()
csv_logger =  CSVLogger("4_5000e_opt=sgd_loss=huber_split=2_bk.csv", append=True)
model.fit(x_train,y_train,
              epochs=5000,batch_size=1,verbose=1,callbacks=[csv_logger])

his=pd.read_csv('4_5000e_opt=sgd_loss=huber_split=2_bk.csv')
...
model1=build_model1()
csv_logger1 =  CSVLogger("4_5000e_opt=sgd_loss=mae_split=2_bk.csv", append=True)
model1.fit(x_train,y_train,
              epochs=5000,batch_size=1,verbose=1,callbacks=[csv_logger1])

his1=pd.read_csv('4_5000e_opt=sgd_loss=mae_split=2_bk.csv')
...
model8=build_model8()
csv_logger8 =  CSVLogger("4_5000e_opt=sgd_loss=mse_split=2_bk.csv", append=True)
model8.fit(x_train,y_train,
              epochs=5000,batch_size=1,verbose=1,callbacks=[csv_logger8])

his8=pd.read_csv('4_5000e_opt=sgd_loss=mse_split=2_bk.csv')
...
model2=build_model2()
csv_logger2 =  CSVLogger("4_5000e_opt=adam_loss=huber_split=2_bk.csv", append=True)
model2.fit(x_train,y_train,
              epochs=5000,batch_size=1,verbose=1,callbacks=[csv_logger2])

his2=pd.read_csv('4_5000e_opt=adam_loss=huber_split=2_bk.csv')
...
model3=build_model3()
csv_logger3 =  CSVLogger("4_5000e_opt=adam_loss=mse_split=2_bk.csv", append=True)
model3.fit(x_train,y_train,
              epochs=5000,batch_size=1,verbose=1,callbacks=[csv_logger3])

his3=pd.read_csv('4_5000e_opt=adam_loss=mse_split=2_bk.csv')
...
model4=build_model4()
csv_logger4 =  CSVLogger("4_5000e_opt=adam_loss=mae_split=2_bk.csv", append=True)
model4.fit(x_train,y_train,
              epochs=5000,batch_size=1,verbose=1,callbacks=[csv_logger4])

his4=pd.read_csv('4_5000e_opt=adam_loss=mae_split=2_bk.csv')
...
model5=build_model5()
csv_logger5 =  CSVLogger("4_5000e_opt=rms_loss=huber_split=2_bk.csv", append=True)
model5.fit(x_train,y_train,
              epochs=5000,batch_size=1,verbose=1,callbacks=[csv_logger5])

his5=pd.read_csv('4_5000e_opt=rms_loss=huber_split=2_bk.csv')
...
model6=build_model6()
csv_logger6 =  CSVLogger("4_5000e_opt=rms_loss=mse_split=2_bk.csv", append=True)
model6.fit(x_train,y_train,
              epochs=5000,batch_size=1,verbose=1,callbacks=[csv_logger6])

his6=pd.read_csv('4_5000e_opt=rms_loss=mse_split=2_bk.csv')
