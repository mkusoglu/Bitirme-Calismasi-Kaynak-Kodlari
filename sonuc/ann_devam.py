...
num_epoch=5000
model=build_model()
csv_logger =  CSVLogger("16x16_5000e_opt=sgd_loss=mse_split=2_random.csv", append=True)
model.fit(x_train,y_train,
              epochs=num_epoch,batch_size=1,verbose=1,callbacks=[csv_logger])

his=pd.read_csv('16x16_5000e_opt=sgd_loss=mse_split=2_random.csv')
...
num_epoch1=5000
model1=build_model1()
csv_logger1 =  CSVLogger("16x16_5000e_opt=sgd_loss=huber=2_random.csv", append=True)
model1.fit(x_train,y_train,
              epochs=num_epoch1,batch_size=1,verbose=1,callbacks=[csv_logger1])

his1=pd.read_csv('16x16_5000e_opt=sgd_loss=huber=2_random.csv')
...
num_epoch3=5000
model3=build_model3()
csv_logger3 =  CSVLogger("16x16_5000e_opt=sgd_loss=huber_split=2_bk.csv", append=True)
model3.fit(x_train2,y_train2,
              epochs=num_epoch3,batch_size=1,verbose=1,callbacks=[csv_logger3])

his3=pd.read_csv('16x16_5000e_opt=sgd_loss=huber_split=2_bk.csv')
